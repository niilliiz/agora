...
export default function Timer({ className = "", autoStart }) {
  ...
  return (
    ...
    >
      <div className={styles.notExpandedContainer}>
        <svg
        ...
        <svg
          className={`${styles.expandIcon} ${isExpanded ? styles.isExpanded : ""}`}
          xmlns="http://www.w3.org/2000/svg"
          width="20"
          height="20"
          viewBox="0 0 20 20"
